<!--
  Template 6: Avatar top-right, name/title top-left, contact below, social at bottom
-->
<script lang="ts">
				...
				<table cellpadding="0" cellspacing="0" style="width:100%;">
					<tbody>
						<tr>
							...
							<!-- Avatar right -->
							<td style="vertical-align:top;text-align:right;padding-left:14px;width:70px;">
								{#if data.avatarUrl}
									<img
										src={data.avatarUrl}
										alt={fullName}
