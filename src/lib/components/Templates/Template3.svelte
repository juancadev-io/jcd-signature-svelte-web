							...
							<td style="padding-right:12px;vertical-align:middle;">
								{#if data.avatarUrl}
									<img
										...
										width="64"
										height="64"
										style="display:block;width:64px !important;height:64px !important;min-width:64px;min-height:64px;max-width:64px;max-height:64px;border-radius:9999px;object-fit:cover;object-position:center center;box-sizing:border-box;{s.avatarBorder
											? `border:${s.avatarBorder}`
											: ''}"
									/>
								{:else}
									<div
										style="width:64px;height:64px;border-radius:50%;background:{data.primaryColor};display:flex;align-items:center;justify-content:center;font-size:22px;font-weight:700;color:#fff;"
									>
										{initials}
									</div>
								{/if}
